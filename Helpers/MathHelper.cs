...
namespace UnityLib
{
    ...
    public static class MathHelper
    {
        ...
        /// </summary>
        public static Vector2Int IndexToCoord(int index, int width) => new Vector2Int(IndexToX(index, width), IndexToY(index, width));
        ...
        /// Converts a 2D coordinate to a 1D index.
        /// </summary>
        public static int CoordToIndex(Vector2Int position, int width) => PositionToIndex(position.x, position.y, width);
    }
}