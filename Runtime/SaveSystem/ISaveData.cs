...
namespace GameKit.SaveSystem
{
    ...
    public static class SaveDataHelper
    {
        ...
        public static void Write<T>(this List<T> binaryDataList, BinaryWriter bw) where T : class, ISaveData, new()
        {
            bw.Write(binaryDataList.Count);
            binaryDataList.ForEach(item => item.Write(bw));
        }

        public static void Read<T>(this List<T> binaryDataList, BinaryReader br) where T : class, ISaveData, new()
        {
        ...
        public static void Write<T>(this List<List<T>> binaryDataLists, BinaryWriter bw) where T : class, ISaveData, new()
        {
            bw.Write(binaryDataLists.Count);
            binaryDataLists.ForEach(item => item.Write(bw));
        }

        public static void Read<T>(this List<List<T>> binaryDataLists, BinaryReader br) where T : class, ISaveData, new()
        {
        ...
        public static void Write<T>(this Dictionary<string, T> binaryDataDictionary, BinaryWriter bw) where T : class, ISaveData, new()
        {
        ...
        public static void Read<T>(this Dictionary<string, T> binaryDataDictionary, Func<T, string> keySelector, BinaryReader br) where T : class, ISaveData, new()
        {
        ...
        public static void Write<T>(this Dictionary<int, Dictionary<string, T>> instancedDictionary, BinaryWriter bw) where T : class, ISaveData, new()
        {
        ...
        public static void Read<T>(this Dictionary<int, Dictionary<string, T>> instancedDictionary, Func<T, string> keySelector, BinaryReader br) where T : class, ISaveData, new()
        {
        ...
        public static T Create<T>(BinaryReader br) where T : class, ISaveData
        {
